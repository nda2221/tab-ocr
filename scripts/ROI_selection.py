...
def detect_lines(image, title='default', rho = 1, theta = np.pi/180, threshold = 50, minLinLength = 1000, maxLineGap = 10, display = False, write = False):
    ...
    #linesP = cv.HoughLinesP(dst, 1 , np.pi / 180, 50, None, 590, 6)
